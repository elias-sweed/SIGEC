...
export const CRITERIOS_OFICIALES: Record<string, CriterioOficial[]> = {
  ...
  'GRAN FINAL · FICHA FINAL': [
    {
      nombre: 'Coreografía y expresión escénica',
      puntaje_maximo: 20,
      indicadores: 'Coordinación, seguridad, expresión corporal, ritmo y desenvolvimiento.',
    },
    {
      nombre: 'Desfile en ropa sport',
      puntaje_maximo: 20,
      indicadores:
        'Naturalidad, seguridad, porte, desenvolvimiento y adecuación de la presentación al contexto escolar.',
    },
    {
      nombre: 'Presentación de talento',
      puntaje_maximo: 20,
      indicadores: 'Evidencia habilidad y preparación en la disciplina seleccionada.',
    },
    {
      nombre: 'Desfile en traje de gala',
      puntaje_maximo: 20,
      indicadores:
